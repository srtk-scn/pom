import React, { useState, memo, forwardRef, useRef, useDebugValue, useEffect, useCallback } from 'react';
...
function useAsObservableSourceInternal(current, usedByLocalStore) {
    ...
    var _a = __read$1(React.useState(function () { return observable(current, {}, { deep: false }); }), 1), res = _a[0];
    ...
    const storeTableColumns = (columns) => {
        ...
        if (options && options.delete) {
            newColumns.push({ title: '삭제', dataIndex: 'remove', key: 'remove', align: 'center',
                render: (text, record) => tableDatas.length >= 1 ? (React.createElement(Popconfirm, { title: "\uC815\uB9D0 \uC0AD\uC81C\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?", placement: "top", okText: "예", cancelText: "아니요", onConfirm: () => deleteTableData(record.key) },
                    React.createElement("a", null, text))) : null
            });
        }
...
const BasicTable = observer((props) => {
    ...
    tableColumns.push({ title: '삭제', dataIndex: 'remove', key: 'remove',
        render: (text, record) => dataSources.length >= 1 ? (React.createElement(Popconfirm, { title: "\uC815\uB9D0 \uC0AD\uC81C\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?", placement: "top", okText: "예", cancelText: "아니요", onConfirm: () => store.deleteData(record.key) },
            React.createElement("a", null, text))) : null
    });
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Table, Object.assign({ columns: store.tableColumns, dataSource: store.dataSources, rowKey: record => record.uid }, rest)),
        React.createElement(Table, Object.assign({ columns: tableStore.getTableColumns(), dataSource: tableStore.getTableDatas(), rowKey: record => record.uid }, rest))));
});
